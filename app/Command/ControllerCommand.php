...
class ControllerCommand extends GeneratorCommand
{
    ...
    {
        return $this->input->getArgument('module') === 'backend' ? $this->getConfig()['namespace'] : 'App\\Controller\\Frontend';
    }
    ...
    protected function getArguments()
    {
        return [
            ...
            ['module', InputArgument::REQUIRED, 'the module type of service, eg. backend, frontend or common ...'],
        ];
    }
}